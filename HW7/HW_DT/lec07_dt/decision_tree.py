import numpy as np
import pandas as pd
import decisiontreeplotter as dplt
...
if __name__ == '__main__':
    ...
    feature_names = {1:{"name":"age of the patient"},
                     2:{"name":"spectacle prescription"},
                     3:{"name":"astigmatic"},
                     4:{"name":"tear production rate"}}
    label_names = {1:"hard contact lenses",2:"soft contact lenses",3:"should not be fitted with contact lenses"}
    treeplt = dplt.DecisionTreePlotter(dt01.tree_,feature_names,label_names)
    treeplt.plot()
